...
// Runtime options (clipboard callbacks, enabling various features, etc.) can generally be set via the uiIO structure.
// You can use UI::SetAllocatorFunctions() before calling UI::CreateContext() to rewire memory allocation functions.
//-----------------------------------------------------------------------------
...
//#define IMGUI_DISABLE_DEFAULT_ALLOCATORS                  // Don't implement default allocators calling malloc()/free() to avoid linking with them. You will need to call UI::SetAllocatorFunctions().
...
// Read about uiBackendFlags_RendererHasVtxOffset for details.
...
//---- Tip: You can add extra functions within the UI:: namespace from anywhere (e.g. your own sources/header files)
/*
namespace UI
{
